...
ɪ ᴀᴍ ʟᴀᴛᴇꜱᴛ ᴀᴅᴠᴀɴᴄᴇᴅ ᴀɴᴅ ᴘᴏᴡᴇʀꜰᴜʟ ᴀᴜᴛᴏ ꜰɪʟᴛᴇʀ ʙᴏᴛ. ʏᴏᴜ ᴄᴀɴ ᴜꜱᴇ ᴍᴇ ɪɴ ʏᴏᴜʀ ɢʀᴏᴜᴘ ᴛᴏ ᴇᴀʀɴ ᴜɴʟɪᴍɪᴛᴇᴅ ᴍᴏɴᴇʏ...💸</b>"""
    ...
    CLONE_START_TXT = """<b><blockquote>ʜᴇʟʟᴏ {}, ᴍʏ ɴᴀᴍᴇ <a href=https://t.me/auto_filter_ak_bot></a>ᴀᴋ ᴀᴜᴛᴏ ғɪʟᴛᴇʀ</blockquote>
...
‣ ᴍʏ ɴᴀᴍᴇ : <a href=https://t.me/anujedits76>ᴀɴᴜᴊ ᴋᴜᴍᴀʀ</a>
...
‣ ᴍʏ ɴᴀᴍᴇ : {}
‣ ᴍʏ ʙᴇsᴛ ғʀɪᴇɴᴅ : <a href='tg://settings'>ᴛʜɪs ᴘᴇʀsᴏɴ</a> 
‣ ᴄʟᴏɴᴇᴅ ғʀᴏᴍ : <a href=http://t.me/auto_filter_ak_bot>ᴀᴋ ᴀᴜᴛᴏ ғɪʟᴛᴇʀ</a>
‣ ʟɪʙʀᴀʀʏ : <a href='https://docs.pyrogram.org/'>ᴘʏʀᴏɢʀᴀᴍ</a> 
‣ ʟᴀɴɢᴜᴀɢᴇ : <a href='https://www.python.org/download/releases/3.0/'>ᴘʏᴛʜᴏɴ 3</a> 
‣ ᴅᴀᴛᴀ ʙᴀsᴇ : <a href='https://www.mongodb.com/'>ᴍᴏɴɢᴏ ᴅʙ</a> 
‣ ʙᴜɪʟᴅ sᴛᴀᴛᴜs : ᴠ2.7.1 [sᴛᴀʙʟᴇ]></b>"""
...
ʀᴇғᴇʀᴀʟ ʟɪɴᴋ - https://telegram.me/auto_filter_ak_bot?start=ᴀᴋ ᴀᴜᴛᴏ ғɪʟᴛᴇʀ
...
<b>ᴜʀʟ ʙᴜᴛᴛᴏɴꜱ:</b>
<code>[ᴀᴋ ᴀᴜᴛᴏ ғɪʟᴛᴇʀ](buttonurl:https://t.me/auto_filter_ak_bot)</code>
<b>ᴀʟᴇʀᴛ ʙᴜᴛᴛᴏɴꜱ:</b>
...
ஏய் <a href='tg://settings'>ᴍʏ ғʀɪᴇɴᴅ</a> 
 ...
 படி 1: இந்த ᴀᴋ ᴀᴜᴛᴏ ғɪʟᴛᴇʀ ʙᴏᴛ போட் உங்கள் குழுவை நிர்வாகியாக்குங்கள்
...
Hey <a href='tg://settings'>ᴍʏ ғʀɪᴇɴᴅ</a> 
 ...
 Step 1: Administer this ᴀᴋ ᴀᴜᴛᴏ ғɪʟᴛᴇʀ ʙᴏᴛ to your group
...
హే <a href='tg://settings'>ᴍʏ ғʀɪᴇɴᴅ</a> 
 ...
 దశ 1: ఈ ᴀᴋ ᴀᴜᴛᴏ ғɪʟᴛᴇʀ ʙᴏᴛ బాట్‌ని మీ సమూహానికి నిర్వహించండి
...
നിങ്ങളുടെ ടീം വീഡിയോ ശേഖരണവും പരിശീലിപ്പിക്കും..."""
 ...
 مرحلہ 1: اپنے گروپ میں اس ᴀᴋ ᴀᴜᴛᴏ ғɪʟᴛᴇʀ ʙᴏᴛ بوٹ کا انتظام کریں۔
...
અરે <a href='tg://settings'>ᴍʏ ғʀɪᴇɴᴅ</a> 
 ...
 પગલું 1: તમારા જૂથમાં આ ᴀᴋ ᴀᴜᴛᴏ ғɪʟᴛᴇʀ ʙᴏᴛ બોટનું સંચાલન કરો
...
আরে <a href='tg://settings'>ᴍʏ ғʀɪᴇɴᴅ</a> 
 ...
 ধাপ 1: আপনার গ্রুপে এই ᴀᴋ ᴀᴜᴛᴏ ғɪʟᴛᴇʀ ʙᴏᴛ বট পরিচালনা করুন
